...
#define DHTPIN    // Pino digital onde o DHT11 
#define DHTTYPE DHT11   // Tipo de sensor DHT
#define SOIL_SENSOR_PIN A0  // Pino analógico onde o sensor de umidade do solo 
#define RELAY_PIN 3   // Pino digital onde o relé 
